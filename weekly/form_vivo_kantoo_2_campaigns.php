...
include 'side_bar.php'; ?>
            ...
            <div class="col-sm-9">
               ...
               <div class="page-header page-header-padding" style="margin:10;padding:0;">
               ...
               <div class="row" >
                  ...
                  <form data-toggle="validator" action="form_vivo_kantoo_2_campaigns_result.php" id="bootstrapSelectForm" method="post" class="form-horizontal" role="form">
