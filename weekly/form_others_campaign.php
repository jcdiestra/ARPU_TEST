...
include '../side_bar.php'; ?>
            ...
            <div class="col-sm-9">
               ...
               <div class="page-header page-header-padding" style="margin:0;padding:0;">
                  ...
                  <h2>Weekly - ARPU Report</h2>
               </div>			  
               <div class="row" >
               </div>	
                  <form data-toggle="validator" action="form_others_campaign_result.php" id="bootstrapSelectForm" method="post" class="form-horizontal" role="form">
