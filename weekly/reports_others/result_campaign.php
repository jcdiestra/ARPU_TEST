...
<div class="container">
			<form action="form_others_campaign_result.php" method="post" id='summary'>
    <input type="hidden" name="report" value="summary" />
    <input type="hidden" name="campaign_id" value="<?php echo $campaign_id ?>" />
  </form>

  <form action="form_others_campaign_result.php" method="post" id='cancellation'>
    <input type="hidden" name="report" value="cancellation" />
    <input type="hidden" name="campaign_id" value="<?php echo $campaign_id ?>" />
  </form>

  <form action="form_others_campaign_result.php" method="post" id='collectionrate'>
    <input type="hidden" name="report" value="collectionrate" />
    <input type="hidden" name="campaign_id" value="<?php echo $campaign_id ?>" />
  </form>

  <form action="form_others_campaign_result.php" method="post" id='arpu'>
    <input type="hidden" name="report" value="arpu" />
    <input type="hidden" name="campaign_id" value="<?php echo $campaign_id ?>" />
  </form>

  <form action="form_others_campaign_result.php" method="post" id='arpuroi'>
