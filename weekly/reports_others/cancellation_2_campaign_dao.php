...
$sql="
select week_date as 'Week Date'
,day_users as 'Total users',
...
if ($result_2) {
  while ($row = mysql_fetch_assoc($result_2)) {
	  ...
	  ///Array X Dimensional:
	  $dataArrayTotal_2[$i]=array($dataX,$dataY2,$dataY3,$dataY4,$dataY5,$dataY6,$dataY7,$dataY8,$dataY9,$dataY10,$dataY11,$dataY12,
	  $dataY13,$dataY14,$dataY15,$dataY16,$dataY17,$dataY18,$dataY19,$dataY20);
	  //echo $dataArrayTotal[$i][0]; echo "</br>";
	  $i++;	  
