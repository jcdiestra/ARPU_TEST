...
{	
	include "reports/summary_dao_2_campaigns.php";
	include "reports/result_2_campaigns.php";
}

if ($report_type=="cancellation")
{	
	include "reports/cancellation_2_campaign_dao.php";
	include "reports/result_2_campaigns.php";	
}

if ($report_type=="collectionrate")
{	
	include 'reports/cr_2_campaign_dao.php';
	include "reports/result_2_campaigns.php";
...
if ($report_type=="arpu")
{	
	include 'reports/arpu_2_campaign_dao.php';
	include "reports/result_2_campaigns.php";
...
{	
	include 'reports/arpuroi_2_campaign_dao.php';
	include "reports/result_2_campaigns.php";
