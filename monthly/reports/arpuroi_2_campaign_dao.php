...
round(".$roi_formula."(1d,rs_operator,opex,tax)/(day_users),3) as '1st ARP',
round(".$roi_formula."(7d,rs_operator,opex,tax)/(day_users),3) as '7 ARP',
round(".$roi_formula."(14d,rs_operator,opex,tax)/(day_users),3) as '14 ARP',
round(".$roi_formula."(21d,rs_operator,opex,tax)/(day_users),3) as '21 ARP',
round(".$roi_formula."(28d,rs_operator,opex,tax)/(day_users),3) as '28 ARP',
round(".$roi_formula."(30d,rs_operator,opex,tax)/(day_users),3) as '30 ARP',
round(".$roi_formula."(60d,rs_operator,opex,tax)/(day_users),3) as '60 ARP',
round(".$roi_formula."(90d,rs_operator,opex,tax)/(day_users),3) as '90 ARP',
round(".$roi_formula."(120d,rs_operator,opex,tax)/(day_users),3) as '120 ARP',
round(".$roi_formula."(150d,rs_operator,opex,tax)/(day_users),3) as '150 ARP',
round(".$roi_formula."(180d,rs_operator,opex,tax)/(day_users),3) as '180 ARP',
round(".$roi_formula."(210d,rs_operator,opex,tax)/(day_users),3) as '210 ARP',
round(".$roi_formula."(240d,rs_operator,opex,tax)/(day_users),3) as '240 ARP',           
round(".$roi_formula."(270d,rs_operator,opex,tax)/(day_users),3) as '270 ARP',  
round(".$roi_formula."(300d,rs_operator,opex,tax)/(day_users),3) as '300 ARP',
round(".$roi_formula."(330d,rs_operator,opex,tax)/(day_users),3) as '330 ARP',  
round(".$roi_formula."(360d,rs_operator,opex,tax)/(day_users),3) as '360 ARP'    
from
...
join 
(select um.*,cp.price,cp.rs_operator,cp.rs_partner,cp.opex,cp.tax from users_monthly um
join campaign cp
on cp.campaignid=um.campaignid
where cp.campaignid=".$campaign_id.") as t2
...
join campaign cp
on cp.campaignid=um.campaignid
where cp.campaignid=".$campaign_id_2.") as t2
on t1.year=t2.year and t1.month=t2.month;";
...
if ($result_2) {
  while ($row = mysql_fetch_assoc($result_2)) {
	  ...
	  ///Array X Dimensional:
	  $dataArrayTotal_2[$i]=array($dataX,$dataY1,$dataY2,$dataY3,$dataY4,$dataY5,$dataY6,$dataY7,$dataY8,$dataY9,$dataY10,$dataY11,$dataY12,
	  $dataY13,$dataY14,$dataY15,$dataY16,$dataY17,$dataY18,$dataY19);
	  //echo $dataArrayTotal[$i][0]; echo "</br>";
	  $i++;	  
